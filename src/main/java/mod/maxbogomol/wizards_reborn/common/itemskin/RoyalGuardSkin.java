...
public class RoyalGuardSkin extends ItemSkin {

    public RoyalGuardSkin(String id, Color color) {
        super(id, color);
    }
    ...
    public void setupSkinEntries() {
        addSkinEntry(new SoulHunterArmorSkinEntry(InventorWizardArmorItem.class,
                WizardsReborn.MOD_ID+":textures/models/armor/skin/royal_guard.png")
                .addArmorSkin(EquipmentSlot.HEAD, WizardsReborn.MOD_ID + ":royal_guard_hat")
                .addArmorSkin(EquipmentSlot.CHEST, WizardsReborn.MOD_ID + ":royal_guard_costume")
                .addArmorSkin(EquipmentSlot.LEGS, WizardsReborn.MOD_ID + ":royal_guard_trousers")
                .addArmorSkin(EquipmentSlot.FEET, WizardsReborn.MOD_ID + ":royal_guard_boots"));
