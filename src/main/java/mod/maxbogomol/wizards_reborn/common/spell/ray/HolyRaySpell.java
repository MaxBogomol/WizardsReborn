            ...
            if (target instanceof LivingEntity livingEntity) {
                if (target.tickCount % 10 == 0) {
                    if (entity.getSpellContext().canRemoveWissen(this)) {
                        ...
                        float damage = (1.0f + (focusLevel * 0.5f)) + magicModifier + WizardsRebornConfig.SPELL_RAY_DAMAGE.get().floatValue() + WizardsRebornConfig.HOLY_RAY_DAMAGE.get().floatValue();
