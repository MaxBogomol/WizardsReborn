...
public class FireAuraSpell extends AuraSpell {
    ...
    public void auraTick(Level level, SpellEntity entity, List<Entity> targets) {
        ...
        if (entity.tickCount % 20 == 0) {
            ...
            float damage = (0.75f + (focusLevel * 0.5f)) + magicModifier + WizardsRebornConfig.SPELL_AURA_DAMAGE.get().floatValue() + WizardsRebornConfig.FIRE_AURA_DAMAGE.get().floatValue();
