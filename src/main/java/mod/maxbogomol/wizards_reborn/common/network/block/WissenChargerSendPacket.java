...
public class WissenChargerSendPacket extends PositionClientPacket {

    public WissenChargerSendPacket(double x, double y, double z) {
        super(x, y, z);
    }

    public WissenChargerSendPacket(BlockPos pos) {
        super(pos);
    }
    ...
    public void execute(Supplier<NetworkEvent.Context> context) {
        ...
        ParticleBuilder.create(FluffyFurParticles.WISP)
                ...
                .spawn(level, x + 0.5f, y + 0.875F, z + 0.5f);
    ...
    public static void register(SimpleChannel instance, int index) {
        instance.registerMessage(index, WissenChargerSendPacket.class, WissenChargerSendPacket::encode, WissenChargerSendPacket::decode, WissenChargerSendPacket::handle);
    }

    public static WissenChargerSendPacket decode(FriendlyByteBuf buf) {
        return decode(WissenChargerSendPacket::new, buf);
    }
}
