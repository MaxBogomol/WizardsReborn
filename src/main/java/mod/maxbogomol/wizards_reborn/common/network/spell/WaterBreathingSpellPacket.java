...
public class WaterBreathingSpellPacket extends PositionColorClientPacket {

    public WaterBreathingSpellPacket(double x, double y, double z, float r, float g, float b, float a) {
        super(x, y, z, r, g, b, a);
    }

    public WaterBreathingSpellPacket(Vec3 pos, Color color) {
        super(pos, color);
    }
