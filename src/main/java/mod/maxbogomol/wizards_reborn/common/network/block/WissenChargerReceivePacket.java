...
public class WissenChargerReceivePacket extends PositionClientPacket {

    public WissenChargerReceivePacket(double x, double y, double z) {
        super(x, y, z);
    }

    public WissenChargerReceivePacket(BlockPos pos) {
        super(pos);
    }
    ...
    public void execute(Supplier<NetworkEvent.Context> context) {
        ...
        ParticleBuilder.create(FluffyFurParticles.WISP)
                ...
                .spawn(level, x + 0.5f, y + 1.1875F, z + 0.5f);
    ...
    public static void register(SimpleChannel instance, int index) {
        instance.registerMessage(index, WissenChargerReceivePacket.class, WissenChargerReceivePacket::encode, WissenChargerReceivePacket::decode, WissenChargerReceivePacket::handle);
    }

    public static WissenChargerReceivePacket decode(FriendlyByteBuf buf) {
        return decode(WissenChargerReceivePacket::new, buf);
    }
}
