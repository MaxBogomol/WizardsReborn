...
public class BlazingWandExtinguishingPacket extends PositionClientPacket {

    public BlazingWandExtinguishingPacket(double x, double y, double z) {
        super(x, y, z);
    }

    public BlazingWandExtinguishingPacket(Vec3 vec) {
        super(vec);
    }

    public BlazingWandExtinguishingPacket(BlockPos pos) {
        super(pos.getCenter());
    }
    ...
    public static void register(SimpleChannel instance, int index) {
        instance.registerMessage(index, BlazingWandExtinguishingPacket.class, BlazingWandExtinguishingPacket::encode, BlazingWandExtinguishingPacket::decode, BlazingWandExtinguishingPacket::handle);
    }

    public static BlazingWandExtinguishingPacket decode(FriendlyByteBuf buf) {
        return decode(BlazingWandExtinguishingPacket::new, buf);
    }
}
