...
public class ProjectileSpellTrailPacket extends ThreePositionColorClientPacket {

    public ProjectileSpellTrailPacket(double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3, float r, float g, float b, float a) {
        super(x1, y1, z1, x2, y2, z2, x3, y3, z3, r, g, b, a);
    }

    public ProjectileSpellTrailPacket(Vec3 vec1, Vec3 vec2, Vec3 vec3, Color color) {
    ...
    public static void register(SimpleChannel instance, int index) {
        instance.registerMessage(index, ProjectileSpellTrailPacket.class, ProjectileSpellTrailPacket::encode, ProjectileSpellTrailPacket::decode, ProjectileSpellTrailPacket::handle);
    }

    public static ProjectileSpellTrailPacket decode(FriendlyByteBuf buf) {
        return decode(ProjectileSpellTrailPacket::new, buf);
    }
}
