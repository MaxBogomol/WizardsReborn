...
public class CrossSpellHeartsPacket extends PositionColorClientPacket {

    public CrossSpellHeartsPacket(double x, double y, double z, float r, float g, float b, float a) {
        super(x, y, z, r, g, b, a);
    }

    public CrossSpellHeartsPacket(Vec3 vec, Color color) {
        super(vec, color);
    }
    ...
    public static void register(SimpleChannel instance, int index) {
        instance.registerMessage(index, CrossSpellHeartsPacket.class, CrossSpellHeartsPacket::encode, CrossSpellHeartsPacket::decode, CrossSpellHeartsPacket::handle);
    }

    public static CrossSpellHeartsPacket decode(FriendlyByteBuf buf) {
        return decode(CrossSpellHeartsPacket::new, buf);
    }
}