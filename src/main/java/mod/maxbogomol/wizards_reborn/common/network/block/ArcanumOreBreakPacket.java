...
public class ArcanumOreBreakPacket extends PositionClientPacket {

    public ArcanumOreBreakPacket(double x, double y, double z) {
        super(x, y, z);
    }

    public ArcanumOreBreakPacket(BlockPos pos) {
        super(pos);
    }
    ...
    public static void register(SimpleChannel instance, int index) {
        instance.registerMessage(index, ArcanumOreBreakPacket.class, ArcanumOreBreakPacket::encode, ArcanumOreBreakPacket::decode, ArcanumOreBreakPacket::handle);
    }

    public static ArcanumOreBreakPacket decode(FriendlyByteBuf buf) {
        return decode(ArcanumOreBreakPacket::new, buf);
    }
}
