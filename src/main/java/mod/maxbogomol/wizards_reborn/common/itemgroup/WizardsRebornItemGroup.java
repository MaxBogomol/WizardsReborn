...
public class WizardsRebornItemGroup {
    ...
    public static void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == WizardsRebornItemGroup.WIZARDS_REBORN_GROUP.getKey()) {
            ...
            event.accept(WizardsReborn.ARCANE_WOOD_BALK_ITEM);
            event.accept(WizardsReborn.ARCANE_WOOD_CROSS_BALK_ITEM);
            event.accept(WizardsReborn.STRIPPED_ARCANE_WOOD_BALK_ITEM);
            event.accept(WizardsReborn.STRIPPED_ARCANE_WOOD_CROSS_BALK_ITEM);
            event.accept(WizardsReborn.ARCANE_WOOD_PLANKS_BALK_ITEM);
            event.accept(WizardsReborn.ARCANE_WOOD_PLANKS_CROSS_BALK_ITEM);
            ...
            event.accept(WizardsReborn.INNOCENT_WOOD_BALK_ITEM);
            event.accept(WizardsReborn.INNOCENT_WOOD_CROSS_BALK_ITEM);
            event.accept(WizardsReborn.STRIPPED_INNOCENT_WOOD_BALK_ITEM);
            event.accept(WizardsReborn.STRIPPED_INNOCENT_WOOD_CROSS_BALK_ITEM);
            event.accept(WizardsReborn.INNOCENT_WOOD_PLANKS_BALK_ITEM);
            event.accept(WizardsReborn.INNOCENT_WOOD_PLANKS_CROSS_BALK_ITEM);
