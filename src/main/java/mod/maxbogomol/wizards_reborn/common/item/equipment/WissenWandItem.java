...
public class WissenWandItem extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand) {
        ...
        if (player.isSneaking()) {
            ...
            nbt.putInt("mode", (nbt.getInt("mode") + 1 ) % 3);
        ...
        if(!world.isRemote) {
            ...
            if (tileentity instanceof IWissenTileEntity) {
                ...
                if (!nbt.getBoolean("block")) {
                    if (((nbt.getInt("mode") == 0) && wissenTile.canConnectReceiveWissen()) || ((nbt.getInt("mode") == 1) && wissenTile.canConnectSendWissen())) {
