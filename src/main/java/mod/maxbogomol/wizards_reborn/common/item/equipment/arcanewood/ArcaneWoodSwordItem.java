...
public class ArcaneWoodSwordItem extends ArcaneSwordItem {

    public final ArcaneWoodTools tools;

    public ArcaneWoodSwordItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Properties properties, Supplier<Item> repairItem) {
