    ...
    public void addParticles(Level level, ItemEntity entity) {
        if (random.nextFloat() < 0.07) {
            ParticleBuilder.create(FluffyFurParticles.WISP)
                    ...
                    .setTransparencyData(GenericParticleData.create(0, 0.5f, 0).setEasing(Easing.SINE_IN_OUT).build())
                    .setScaleData(GenericParticleData.create(0f, 0.1f, 0).setEasing(Easing.SINE_IN_OUT).build())
