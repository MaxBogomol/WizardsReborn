...
public class SniffaloCarpetArmorModel extends SniffaloArmorModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition carpet = body.addOrReplaceChild("carpet", CubeListBuilder.create().texOffs(0, 0).addBox(-14.5F, -23.0F, 10.0F, 29.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.ZERO);
        PartDefinition carpet_layer = body.addOrReplaceChild("carpet_layer", CubeListBuilder.create().texOffs(0, 16).addBox(-14.5F, -23.0F, 10.0F, 29.0F, 8.0F, 8.0F, new CubeDeformation(0.75F)), PartPose.ZERO);

        PartDefinition right_bottom_carpet = body.addOrReplaceChild("right_bottom_carpet", CubeListBuilder.create().texOffs(0, 32).addBox(-13.5F, -14.0F, 10.0F, 1.0F, 10.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.ZERO);
        PartDefinition right_bottom_carpet_layer = body.addOrReplaceChild("right_bottom_carpet_layer", CubeListBuilder.create().texOffs(0, 50).addBox(-13.5F, -14.0F, 10.0F, 1.0F, 10.0F, 8.0F, new CubeDeformation(0.7F)), PartPose.ZERO);
