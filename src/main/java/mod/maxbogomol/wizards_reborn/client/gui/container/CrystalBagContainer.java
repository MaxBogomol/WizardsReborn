...
public class CrystalBagContainer extends ContainerMenuBase {
    public final ItemStack itemStack;
    private final Container inventory;

    public CrystalBagContainer(int windowId, Level level, ItemStack stack, Inventory playerInventory, Player player) {
        super(WizardsRebornMenuTypes.CRYSTAL_BAG_CONTAINER.get(), windowId);
