...
public class AlchemyBagScreen extends AbstractContainerScreen<AlchemyBagMenu> {
    ...
    public AlchemyBagScreen(AlchemyBagMenu screenContainer, Inventory inv, Component titleIn) {
