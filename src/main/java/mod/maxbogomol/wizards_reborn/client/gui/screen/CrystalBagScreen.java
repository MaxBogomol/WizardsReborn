...
public class CrystalBagScreen extends AbstractContainerScreen<CrystalBagMenu> {
    ...
    public CrystalBagScreen(CrystalBagMenu screenContainer, Inventory inv, Component titleIn) {
