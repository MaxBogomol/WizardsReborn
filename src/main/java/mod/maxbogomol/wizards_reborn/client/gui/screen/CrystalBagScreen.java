...
public class CrystalBagScreen extends AbstractContainerScreen<CrystalBagContainer> {
    private final ResourceLocation GUI = new ResourceLocation(WizardsReborn.MOD_ID, "textures/gui/bag.png");

    public CrystalBagScreen(CrystalBagContainer screenContainer, Inventory inv, Component titleIn) {
