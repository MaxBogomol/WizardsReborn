...
public class CargoCarpetScreen extends AbstractContainerScreen<CargoCarpetMenu> {
    ...
    public CargoCarpetScreen(CargoCarpetMenu screenContainer, Inventory inv, Component titleIn) {
