...
public class AlchemyFurnaceContainer extends AbstractContainerMenu {
    ...
    protected AlchemyFurnaceContainer(@Nullable MenuType<?> pMenuType, int pContainerId, BlockEntity tileEntity, Player playerEntity, IItemHandler playerInventory) {
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()),
                playerIn, WizardsReborn.ALCHEMY_FURNACE.get());
    }
