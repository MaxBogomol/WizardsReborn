...
public class ExperienceTotemBurst {
    ...
    public ExperienceTotemBurst(Level level, float x, float y, float z, float endX, float endY, float endZ, float speed, float upTicks, float endTick, float R, float G, float B) {
        this.level = level;
        this.x = x;
        this.y = y;
        this.z = z;
