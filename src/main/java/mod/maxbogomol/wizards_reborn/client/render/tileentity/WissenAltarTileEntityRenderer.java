...
public class WissenAltarTileEntityRenderer implements BlockEntityRenderer<WissenAltarTileEntity> {

    public WissenAltarTileEntityRenderer() {}

    @Override
    public void render(WissenAltarTileEntity altar, float partialTicks, PoseStack ms, MultiBufferSource buffers, int light, int overlay) {
