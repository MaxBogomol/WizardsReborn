...
public class MonogramIndexPage extends Page {
    public static final ResourceLocation BACKGROUND = new ResourceLocation(WizardsReborn.MOD_ID, "textures/gui/arcanemicon_monogram_index_page.png");
    ...
    public void render(ArcanemiconGui gui, MatrixStack mStack, int x, int y, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < entries.length; i ++) {
            entries[i].icon.renderArcanemiconIcon(gui, mStack, x + 3, y + 8 + i * 20);
