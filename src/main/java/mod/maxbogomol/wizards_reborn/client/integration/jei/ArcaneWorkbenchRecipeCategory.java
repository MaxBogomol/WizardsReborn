...
public class ArcaneWorkbenchRecipeCategory implements IRecipeCategory<ArcaneWorkbenchRecipe> {
    ...
    public ArcaneWorkbenchRecipeCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(WizardsReborn.ARCANE_WORKBENCH_ITEM.get()));
    }
    ...
    public Component getTitle() {
        return Component.nullToEmpty(WizardsReborn.ARCANE_WORKBENCH.get().getName().getString());
    }
