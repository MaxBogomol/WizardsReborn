...
public class JewelerTableRecipeCategory implements IRecipeCategory<JewelerTableRecipe> {
    ...
    public JewelerTableRecipeCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(WizardsReborn.JEWELER_TABLE_ITEM.get()));
    }
    ...
    public Component getTitle() {
        return Component.nullToEmpty(WizardsReborn.JEWELER_TABLE.get().getName().getString());
    }
