...
import mod.maxbogomol.fluffy_fur.registry.common.FluffyFurMobEffects;
...
public class WizardsRebornItems {
    ...
    //EQUIPMENT
    public static final RegistryObject<Item> ARCANE_WOOD_SWORD = ITEMS.register("arcane_wood_sword", () -> new ArcaneWoodSwordItem(WizardsRebornItemTiers.ARCANE_WOOD, 3, -2.4f, new Item.Properties(), ARCANE_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.ARCANE_WOOD));
    public static final RegistryObject<Item> ARCANE_WOOD_PICKAXE = ITEMS.register("arcane_wood_pickaxe", () -> new ArcaneWoodPickaxeItem(WizardsRebornItemTiers.ARCANE_WOOD, 1, -2.8f, new Item.Properties(), ARCANE_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.ARCANE_WOOD));
    public static final RegistryObject<Item> ARCANE_WOOD_AXE = ITEMS.register("arcane_wood_axe", () -> new ArcaneWoodAxeItem(WizardsRebornItemTiers.ARCANE_WOOD, 6, -3.1f, new Item.Properties(), ARCANE_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.ARCANE_WOOD));
    public static final RegistryObject<Item> ARCANE_WOOD_SHOVEL = ITEMS.register("arcane_wood_shovel", () -> new ArcaneWoodShovelItem(WizardsRebornItemTiers.ARCANE_WOOD, 1.5f, -3f, new Item.Properties(), ARCANE_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.ARCANE_WOOD));
    public static final RegistryObject<Item> ARCANE_WOOD_HOE = ITEMS.register("arcane_wood_hoe", () -> new ArcaneWoodHoeItem(WizardsRebornItemTiers.ARCANE_WOOD, -1, -1f, new Item.Properties(), ARCANE_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.ARCANE_WOOD));
    public static final RegistryObject<Item> ARCANE_WOOD_SCYTHE = ITEMS.register("arcane_wood_scythe", () -> new ArcaneWoodScytheItem(WizardsRebornItemTiers.ARCANE_WOOD, 4, -2.8f, new Item.Properties(), 0.5f, 0, ARCANE_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.ARCANE_WOOD));
    ...
    public static final RegistryObject<Item> INNOCENT_WOOD_SWORD = ITEMS.register("innocent_wood_sword", () -> new InnocentWoodSwordItem(WizardsRebornItemTiers.INNOCENT_WOOD, 3, -2.4f, new Item.Properties(), INNOCENT_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.INNOCENT_WOOD));
    public static final RegistryObject<Item> INNOCENT_WOOD_PICKAXE = ITEMS.register("innocent_wood_pickaxe", () -> new InnocentWoodPickaxeItem(WizardsRebornItemTiers.INNOCENT_WOOD, 1, -2.8f, new Item.Properties(), INNOCENT_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.INNOCENT_WOOD));
    public static final RegistryObject<Item> INNOCENT_WOOD_AXE = ITEMS.register("innocent_wood_axe", () -> new InnocentWoodAxeItem(WizardsRebornItemTiers.INNOCENT_WOOD, 6, -3.1f, new Item.Properties(), INNOCENT_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.INNOCENT_WOOD));
    public static final RegistryObject<Item> INNOCENT_WOOD_SHOVEL = ITEMS.register("innocent_wood_shovel", () -> new InnocentWoodShovelItem(WizardsRebornItemTiers.INNOCENT_WOOD, 1.5f, -3f, new Item.Properties(), INNOCENT_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.INNOCENT_WOOD));
    public static final RegistryObject<Item> INNOCENT_WOOD_HOE = ITEMS.register("innocent_wood_hoe", () -> new InnocentWoodHoeItem(WizardsRebornItemTiers.INNOCENT_WOOD, -1, -1f, new Item.Properties(), INNOCENT_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.INNOCENT_WOOD));
    public static final RegistryObject<Item> INNOCENT_WOOD_SCYTHE = ITEMS.register("innocent_wood_scythe", () -> new InnocentWoodScytheItem(WizardsRebornItemTiers.INNOCENT_WOOD, 4, -2.8f, new Item.Properties(), 0.5f, 0, INNOCENT_WOOD_BRANCH).addArcaneEnchantmentType(ArcaneEnchantmentTypes.INNOCENT_WOOD));
    ...
    public static final RegistryObject<Item> BLACK_CARGO_CARPET = ITEMS.register("black_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.BLACK_CARGO_CARPET.get(), CargoCarpetItem.BLACK, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> BROWN_CARGO_CARPET = ITEMS.register("brown_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.BROWN_CARGO_CARPET.get(), CargoCarpetItem.BROWN, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> RED_CARGO_CARPET = ITEMS.register("red_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.RED_CARGO_CARPET.get(), CargoCarpetItem.RED, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ORANGE_CARGO_CARPET = ITEMS.register("orange_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.ORANGE_CARGO_CARPET.get(), CargoCarpetItem.ORANGE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> YELLOW_CARGO_CARPET = ITEMS.register("yellow_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.YELLOW_CARGO_CARPET.get(), CargoCarpetItem.YELLOW, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> LIME_CARGO_CARPET = ITEMS.register("lime_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.LIME_CARGO_CARPET.get(), CargoCarpetItem.LIME, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> GREEN_CARGO_CARPET = ITEMS.register("green_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.GREEN_CARGO_CARPET.get(), CargoCarpetItem.GREEN, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> CYAN_CARGO_CARPET = ITEMS.register("cyan_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.CYAN_CARGO_CARPET.get(), CargoCarpetItem.CYAN, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> LIGHT_BLUE_CARGO_CARPET = ITEMS.register("light_blue_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.LIGHT_BLUE_CARGO_CARPET.get(), CargoCarpetItem.LIGHT_BLUE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> BLUE_CARGO_CARPET = ITEMS.register("blue_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.BLUE_CARGO_CARPET.get(), CargoCarpetItem.BLUE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> PURPLE_CARGO_CARPET = ITEMS.register("purple_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.PURPLE_CARGO_CARPET.get(), CargoCarpetItem.PURPLE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MAGENTA_CARGO_CARPET = ITEMS.register("magenta_cargo_carpet", () -> new CargoCarpetItem(WizardsRebornBlocks.MAGENTA_CARGO_CARPET.get(), CargoCarpetItem.MAGENTA, new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> ASCENSION_BANNER_PATTERN = ITEMS.register("ascension_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.ASCENSION, WizardsRebornBannerPatternTags.ASCENSION_BANNER, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> MUSIC_DISC_ARCANUM = ITEMS.register("music_disc_arcanum", () -> new ArcaneRecordItem(1, WizardsRebornSounds.MUSIC_DISC_ARCANUM.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 122, new Color(203, 234, 251)));
    public static final RegistryObject<Item> MUSIC_DISC_MOR = ITEMS.register("music_disc_mor", () -> new ArcaneRecordItem(2, WizardsRebornSounds.MUSIC_DISC_MOR.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 305, new Color(244, 245, 230)));
    public static final RegistryObject<Item> MUSIC_DISC_REBORN = ITEMS.register("music_disc_reborn", () -> new ArcaneRecordItem(3, WizardsRebornSounds.MUSIC_DISC_REBORN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 211, new Color(252, 240, 175)));
    public static final RegistryObject<Item> MUSIC_DISC_SHIMMER = ITEMS.register("music_disc_shimmer", () -> new ArcaneRecordItem(5, WizardsRebornSounds.MUSIC_DISC_SHIMMER.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 234, new Color(203, 234, 251)));
    ...
    public static final RegistryObject<Item> MUSIC_DISC_PANACHE = ITEMS.register("music_disc_panache", () -> new ArcaneRecordItem(4, WizardsRebornSounds.MUSIC_DISC_PANACHE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 91, new Color(252, 240, 175)).setCassette());
    public static final RegistryObject<Item> MUSIC_DISC_DISCO = ITEMS.register("music_disc_disco", () -> new ArcaneRecordItem(7, WizardsRebornSounds.MUSIC_DISC_DISCO.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 138, new Color(184, 231, 131)).setCassette());
    ...
    public static final RegistryObject<Item> CARROT_PIE = ITEMS.register("carrot_pie", () -> new ArcaneFoodItem(new Item.Properties().food(WizardsRebornFoods.CARROT_PIE)).setNourishmentTick(1200));

    public static final RegistryObject<Item> BLIN = ITEMS.register("blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> CREPE = ITEMS.register("crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.BLIN)).setNourishmentTick(1200));
    ...
    public static final RegistryObject<Item> GLOW_BERRIES_JAM_BLIN = ITEMS.register("glow_berries_jam_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.GLOW_BERRIES_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> GLOW_BERRIES_JAM_CREPE = ITEMS.register("glow_berries_jam_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.GLOW_BERRIES_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> UNDERGROUND_GRAPE_JAM_BLIN = ITEMS.register("underground_grape_jam_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.UNDERGROUND_GRAPE_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> UNDERGROUND_GRAPE_JAM_CREPE = ITEMS.register("underground_grape_jam_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.UNDERGROUND_GRAPE_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> PITCHER_DEW_JAM_BLIN = ITEMS.register("pitcher_dew_jam_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.PITCHER_DEW_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> PITCHER_DEW_JAM_CREPE = ITEMS.register("pitcher_dew_jam_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.PITCHER_DEW_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> SHINY_CLOVER_JAM_BLIN = ITEMS.register("shiny_clover_jam_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.SHINY_CLOVER_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> SHINY_CLOVER_JAM_CREPE = ITEMS.register("shiny_clover_jam_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.SHINY_CLOVER_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> MOR_JAM_BLIN = ITEMS.register("mor_jam_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.MOR_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> MOR_JAM_CREPE = ITEMS.register("mor_jam_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.MOR_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> ELDER_MOR_JAM_BLIN = ITEMS.register("elder_mor_jam_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.ELDER_MOR_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> ELDER_MOR_JAM_CREPE = ITEMS.register("elder_mor_jam_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.ELDER_MOR_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> HONEY_BLIN = ITEMS.register("honey_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.HONEY_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> HONEY_CREPE = ITEMS.register("honey_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.HONEY_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> CHOCOLATE_BLIN = ITEMS.register("chocolate_blin", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.CHOCOLATE_BLIN)).setNourishmentTick(1200));
    public static final RegistryObject<Item> CHOCOLATE_CREPE = ITEMS.register("chocolate_crepe", () -> new PancakeItem(new Item.Properties().food(WizardsRebornFoods.CHOCOLATE_BLIN)).setNourishmentTick(1200));
    ...
    public static final RegistryObject<Item> GLOW_BERRIES_JAM_VIAL = ITEMS.register("glow_berries_jam_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.GLOW_BERRIES_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> GLOW_BERRIES_JAM_FLASK = ITEMS.register("glow_berries_jam_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.GLOW_BERRIES_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> UNDERGROUND_GRAPE_JAM_VIAL = ITEMS.register("underground_grape_jam_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.UNDERGROUND_GRAPE_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> UNDERGROUND_GRAPE_JAM_FLASK = ITEMS.register("underground_grape_jam_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.UNDERGROUND_GRAPE_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> PITCHER_DEW_JAM_VIAL = ITEMS.register("pitcher_dew_jam_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.PITCHER_DEW_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> PITCHER_DEW_JAM_FLASK = ITEMS.register("pitcher_dew_jam_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.PITCHER_DEW_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> SHINY_CLOVER_JAM_VIAL = ITEMS.register("shiny_clover_jam_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.SHINY_CLOVER_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> SHINY_CLOVER_JAM_FLASK = ITEMS.register("shiny_clover_jam_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.SHINY_CLOVER_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> MOR_JAM_VIAL = ITEMS.register("mor_jam_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.MOR_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> MOR_JAM_FLASK = ITEMS.register("mor_jam_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.MOR_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> ELDER_MOR_JAM_VIAL = ITEMS.register("elder_mor_jam_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.ELDER_MOR_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> ELDER_MOR_JAM_FLASK = ITEMS.register("elder_mor_jam_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.ELDER_MOR_JAM)).setNourishmentTick(1200));
    public static final RegistryObject<Item> HONEY_VIAL = ITEMS.register("honey_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.HONEY)).setNourishmentTick(1200));
    public static final RegistryObject<Item> HONEY_FLASK = ITEMS.register("honey_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.HONEY)).setNourishmentTick(1200));
    public static final RegistryObject<Item> CHOCOLATE_VIAL = ITEMS.register("chocolate_vial", () -> new VialJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.CHOCOLATE)).setNourishmentTick(1200));
    public static final RegistryObject<Item> CHOCOLATE_FLASK = ITEMS.register("chocolate_flask", () -> new FlaskJamItem(new Item.Properties().stacksTo(16).food(WizardsRebornFoods.CHOCOLATE)).setNourishmentTick(1200));
