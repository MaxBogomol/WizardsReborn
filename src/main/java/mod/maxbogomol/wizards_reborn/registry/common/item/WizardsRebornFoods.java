...
public class WizardsRebornFoods {
    ...
    public static final FoodProperties SWEET_BERRIES_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    public static final FoodProperties GLOW_BERRIES_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    public static final FoodProperties UNDERGROUND_GRAPE_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    public static final FoodProperties PITCHER_DEW_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    public static final FoodProperties SHINY_CLOVER_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    public static final FoodProperties MOR_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).effect(() -> new MobEffectInstance(WizardsRebornMobEffects.MOR_SPORES.get(), 200, 0), 1.0F).build();
    public static final FoodProperties ELDER_MOR_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).effect(() -> new MobEffectInstance(WizardsRebornMobEffects.MOR_SPORES.get(), 300, 0), 1.0F).build();
    public static final FoodProperties HONEY_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    public static final FoodProperties CHOCOLATE_BLIN = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).build();
    ...
    public static final FoodProperties MOR_JAM = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.2F).effect(() -> new MobEffectInstance(WizardsRebornMobEffects.MOR_SPORES.get(), 200, 0), 1.0F).alwaysEat().build();
    public static final FoodProperties ELDER_MOR_JAM = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.2F).effect(() -> new MobEffectInstance(WizardsRebornMobEffects.MOR_SPORES.get(), 300, 0), 1.0F).alwaysEat().build();
