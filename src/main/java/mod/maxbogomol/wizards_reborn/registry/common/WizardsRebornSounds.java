...
public class WizardsRebornSounds {
    ...
    public static final RegistryObject<SoundEvent> ARCANE_GOLD_FALL = SOUND_EVENTS.register("arcane_gold_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcane_gold_fall")));
    ...
    public static final RegistryObject<SoundEvent> ARCANE_GOLD_ORE_FALL = SOUND_EVENTS.register("arcane_gold_ore_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcane_gold_ore_fall")));
    ...
    public static final RegistryObject<SoundEvent> DEEPSLATE_ARCANE_GOLD_ORE_FALL = SOUND_EVENTS.register("deepslate_arcane_gold_ore_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "deepslate_arcane_gold_ore_fall")));
    ...
    public static final RegistryObject<SoundEvent> NETHER_ARCANE_GOLD_ORE_FALL = SOUND_EVENTS.register("nether_arcane_gold_ore_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "nether_arcane_gold_ore_fall")));
    ...
    public static final RegistryObject<SoundEvent> RAW_ARCANE_GOLD_FALL = SOUND_EVENTS.register("raw_arcane_gold_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "raw_arcane_gold_fall")));
    ...
    public static final RegistryObject<SoundEvent> SARCON_FALL = SOUND_EVENTS.register("sarcon_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "sarcon_fall")));
    ...
    public static final RegistryObject<SoundEvent> VILENIUM_FALL = SOUND_EVENTS.register("vilenium_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "vilenium_fall")));
    ...
    public static final RegistryObject<SoundEvent> ARCANUM_FALL = SOUND_EVENTS.register("arcanum_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcanum_fall")));
    ...
    public static final RegistryObject<SoundEvent> ARCANUM_ORE_FALL = SOUND_EVENTS.register("arcanum_ore_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcanum_ore_fall")));
    ...
    public static final RegistryObject<SoundEvent> DEEPSLATE_ARCANUM_ORE_FALL = SOUND_EVENTS.register("deepslate_arcanum_ore_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "deepslate_arcanum_ore_fall")));
    ...
    public static final RegistryObject<SoundEvent> ARCACITE_FALL = SOUND_EVENTS.register("arcacite_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcacite_fall")));
    ...
    public static final RegistryObject<SoundEvent> PRECISION_CRYSTAL_FALL = SOUND_EVENTS.register("precision_crystal_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "precision_crystal_fall")));
    ...
    public static final RegistryObject<SoundEvent> NETHER_SALT_FALL = SOUND_EVENTS.register("nether_salt_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "nether_salt_fall")));
    ...
    public static final RegistryObject<SoundEvent> NETHER_SALT_ORE_FALL = SOUND_EVENTS.register("nether_salt_ore_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "nether_salt_ore_fall")));
    ...
    public static final RegistryObject<SoundEvent> MIXTURE_FALL = SOUND_EVENTS.register("mixture_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "mixture_fall")));
    ...
    public static final RegistryObject<SoundEvent> ARCANE_WOOD_FALL = SOUND_EVENTS.register("arcane_wood_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcane_wood_fall")));
    ...
    public static final RegistryObject<SoundEvent> ARCANE_WOOD_HANGING_SIGN_FALL = SOUND_EVENTS.register("arcane_wood_hanging_sign_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "arcane_wood_hanging_sign_fall")));
    ...
    public static final RegistryObject<SoundEvent> INNOCENT_WOOD_FALL = SOUND_EVENTS.register("innocent_wood_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "innocent_wood_fall")));
    ...
    public static final RegistryObject<SoundEvent> INNOCENT_WOOD_HANGING_SIGN_FALL = SOUND_EVENTS.register("innocent_wood_hanging_sign_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "innocent_wood_hanging_sign_fall")));
    ...
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_BREAK = SOUND_EVENTS.register("cork_bamboo_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_break")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_STEP = SOUND_EVENTS.register("cork_bamboo_step", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_step")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_PLACE = SOUND_EVENTS.register("cork_bamboo_place", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_place")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_HIT = SOUND_EVENTS.register("cork_bamboo_hit", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_hit")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_FALL = SOUND_EVENTS.register("cork_bamboo_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_fall")));

    public static final RegistryObject<SoundEvent> CORK_BAMBOO_SAPLING_BREAK = SOUND_EVENTS.register("cork_bamboo_sapling_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_sapling_break")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_SAPLING_PLACE = SOUND_EVENTS.register("cork_bamboo_sapling_place", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_sapling_place")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_SAPLING_HIT = SOUND_EVENTS.register("cork_bamboo_sapling_hit", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_sapling_hit")));

    public static final RegistryObject<SoundEvent> CORK_BAMBOO_WOOD_BREAK = SOUND_EVENTS.register("cork_bamboo_wood_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_wood_break")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_WOOD_STEP = SOUND_EVENTS.register("cork_bamboo_wood_step", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_wood_step")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_WOOD_PLACE = SOUND_EVENTS.register("cork_bamboo_wood_place", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_wood_place")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_WOOD_HIT = SOUND_EVENTS.register("cork_bamboo_wood_hit", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_wood_hit")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_WOOD_FALL = SOUND_EVENTS.register("cork_bamboo_wood_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_wood_fall")));

    public static final RegistryObject<SoundEvent> CORK_BAMBOO_HANGING_SIGN_BREAK = SOUND_EVENTS.register("cork_bamboo_hanging_sign_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_hanging_sign_break")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_HANGING_SIGN_STEP = SOUND_EVENTS.register("cork_bamboo_hanging_sign_step", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_hanging_sign_step")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_HANGING_SIGN_PLACE = SOUND_EVENTS.register("cork_bamboo_hanging_sign_place", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_hanging_sign_place")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_HANGING_SIGN_HIT = SOUND_EVENTS.register("cork_bamboo_hanging_sign_hit", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_hanging_sign_hit")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_HANGING_SIGN_FALL = SOUND_EVENTS.register("cork_bamboo_hanging_sign_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_hanging_sign_fall")));

    public static final RegistryObject<SoundEvent> CORK_BAMBOO_BUTTON_CLICK_OFF = SOUND_EVENTS.register("cork_bamboo_button_click_off", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_button_click_off")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_BUTTON_CLICK_ON = SOUND_EVENTS.register("cork_bamboo_button_click_on", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_button_click_on")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_PRESSURE_PLATE_CLICK_OFF = SOUND_EVENTS.register("cork_bamboo_pressure_plate_click_off", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_pressure_plate_click_off")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_PRESSURE_PLATE_CLICK_ON = SOUND_EVENTS.register("cork_bamboo_pressure_plate_click_on", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_pressure_plate_click_on")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_FENCE_GATE_CLOSE = SOUND_EVENTS.register("cork_bamboo_fence_gate_close", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_fence_gate_close")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_FENCE_GATE_OPEN = SOUND_EVENTS.register("cork_bamboo_fence_gate_open", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_fence_gate_open")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_DOOR_CLOSE = SOUND_EVENTS.register("cork_bamboo_door_close", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_door_close")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_DOOR_OPEN = SOUND_EVENTS.register("cork_bamboo_door_open", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_door_open")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_TRAPDOOR_CLOSE = SOUND_EVENTS.register("cork_bamboo_trapdoor_close", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_trapdoor_close")));
    public static final RegistryObject<SoundEvent> CORK_BAMBOO_TRAPDOOR_OPEN = SOUND_EVENTS.register("cork_bamboo_trapdoor_open", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "cork_bamboo_trapdoor_open")));
    ...
    public static final RegistryObject<SoundEvent> WISESTONE_FALL = SOUND_EVENTS.register("wisestone_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "wisestone_fall")));
    ...
    public static final RegistryObject<SoundEvent> POLISHED_WISESTONE_FALL = SOUND_EVENTS.register("polished_wisestone_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "polished_wisestone_fall")));
    ...
    public static final RegistryObject<SoundEvent> WISESTONE_BRICKS_FALL = SOUND_EVENTS.register("wisestone_bricks_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "wisestone_bricks_fall")));
    ...
    public static final RegistryObject<SoundEvent> WISESTONE_TILE_FALL = SOUND_EVENTS.register("wisestone_tile_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "wisestone_tile_fall")));
    ...
    public static final RegistryObject<SoundEvent> CHISELED_WISESTONE_FALL = SOUND_EVENTS.register("chiseled_wisestone_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "chiseled_wisestone_fall")));
    ...
    public static final RegistryObject<SoundEvent> MOR_FALL = SOUND_EVENTS.register("mor_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "mor_fall")));
    ...
    public static final RegistryObject<SoundEvent> ELDER_MOR_FALL = SOUND_EVENTS.register("elder_mor_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "elder_mor_fall")));
    ...
    public static final RegistryObject<SoundEvent> MOR_BLOCK_FALL = SOUND_EVENTS.register("mor_block_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "mor_block_fall")));
    ...
    public static final RegistryObject<SoundEvent> ELDER_MOR_BLOCK_FALL = SOUND_EVENTS.register("elder_mor_block_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "elder_mor_block_fall")));
    ...
    public static final RegistryObject<SoundEvent> CRYSTAL_FALL = SOUND_EVENTS.register("crystal_fall", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(WizardsReborn.MOD_ID, "crystal_fall")));
    ...
    public static final ForgeSoundType ARCANE_GOLD = new ForgeSoundType(1f, 1f, ARCANE_GOLD_BREAK, ARCANE_GOLD_STEP, ARCANE_GOLD_PLACE, ARCANE_GOLD_HIT, ARCANE_GOLD_FALL);
    public static final ForgeSoundType ARCANE_GOLD_ORE = new ForgeSoundType(1f, 1f, ARCANE_GOLD_ORE_BREAK, ARCANE_GOLD_ORE_STEP, ARCANE_GOLD_ORE_PLACE, ARCANE_GOLD_ORE_HIT, ARCANE_GOLD_ORE_FALL);
    public static final ForgeSoundType DEEPSLATE_ARCANE_GOLD_ORE = new ForgeSoundType(1f, 1f, DEEPSLATE_ARCANE_GOLD_ORE_BREAK, DEEPSLATE_ARCANE_GOLD_ORE_STEP, DEEPSLATE_ARCANE_GOLD_ORE_PLACE, DEEPSLATE_ARCANE_GOLD_ORE_HIT, DEEPSLATE_ARCANE_GOLD_ORE_FALL);
    public static final ForgeSoundType NETHER_ARCANE_GOLD_ORE = new ForgeSoundType(1f, 1f, NETHER_ARCANE_GOLD_ORE_BREAK, NETHER_ARCANE_GOLD_ORE_STEP, NETHER_ARCANE_GOLD_ORE_PLACE, NETHER_ARCANE_GOLD_ORE_HIT, NETHER_ARCANE_GOLD_ORE_FALL);
    public static final ForgeSoundType RAW_ARCANE_GOLD = new ForgeSoundType(1f, 1f, RAW_ARCANE_GOLD_BREAK, RAW_ARCANE_GOLD_STEP, RAW_ARCANE_GOLD_PLACE, RAW_ARCANE_GOLD_HIT, RAW_ARCANE_GOLD_FALL);
    public static final ForgeSoundType SARCON = new ForgeSoundType(1f, 1f, SARCON_BREAK, SARCON_STEP, SARCON_PLACE, SARCON_HIT, SARCON_FALL);
    public static final ForgeSoundType VILENIUM = new ForgeSoundType(1f, 1f, VILENIUM_BREAK, VILENIUM_STEP, VILENIUM_PLACE, VILENIUM_HIT, VILENIUM_FALL);
    public static final ForgeSoundType ARCANUM = new ForgeSoundType(1f, 1f, ARCANUM_BREAK, ARCANUM_STEP, ARCANUM_PLACE, ARCANUM_HIT, ARCANUM_FALL);
    public static final ForgeSoundType ARCANUM_ORE = new ForgeSoundType(1f, 1f, ARCANUM_ORE_BREAK, ARCANUM_ORE_STEP, ARCANUM_ORE_PLACE, ARCANUM_ORE_HIT, ARCANUM_ORE_FALL);
    public static final ForgeSoundType DEEPSLATE_ARCANUM_ORE = new ForgeSoundType(1f, 1f, DEEPSLATE_ARCANUM_ORE_BREAK, DEEPSLATE_ARCANUM_ORE_STEP, DEEPSLATE_ARCANUM_ORE_PLACE, DEEPSLATE_ARCANUM_ORE_HIT, DEEPSLATE_ARCANUM_ORE_FALL);
    public static final ForgeSoundType ARCACITE = new ForgeSoundType(1f, 1f, ARCACITE_BREAK, ARCACITE_STEP, ARCACITE_PLACE, ARCACITE_HIT, ARCACITE_FALL);
    public static final ForgeSoundType PRECISION_CRYSTAL = new ForgeSoundType(1f, 1f, PRECISION_CRYSTAL_BREAK, PRECISION_CRYSTAL_STEP, PRECISION_CRYSTAL_PLACE, PRECISION_CRYSTAL_HIT, PRECISION_CRYSTAL_FALL);
    public static final ForgeSoundType NETHER_SALT = new ForgeSoundType(1f, 1f, NETHER_SALT_BREAK, NETHER_SALT_STEP, NETHER_SALT_PLACE, NETHER_SALT_HIT, NETHER_SALT_FALL);
    public static final ForgeSoundType NETHER_SALT_ORE = new ForgeSoundType(1f, 1f, NETHER_SALT_ORE_BREAK, NETHER_SALT_ORE_STEP, NETHER_SALT_ORE_PLACE, NETHER_SALT_ORE_HIT, NETHER_SALT_ORE_FALL);
    public static final ForgeSoundType MIXTURE = new ForgeSoundType(1f, 1f, MIXTURE_BREAK, MIXTURE_STEP, MIXTURE_PLACE, MIXTURE_HIT, MIXTURE_FALL);
    public static final ForgeSoundType ARCANE_WOOD = new ForgeSoundType(1f, 1f, ARCANE_WOOD_BREAK, ARCANE_WOOD_STEP, ARCANE_WOOD_PLACE, ARCANE_WOOD_HIT, ARCANE_WOOD_FALL);
    public static final ForgeSoundType ARCANE_WOOD_HANGING_SIGN = new ForgeSoundType(1f, 1f, ARCANE_WOOD_HANGING_SIGN_BREAK, ARCANE_WOOD_HANGING_SIGN_STEP, ARCANE_WOOD_HANGING_SIGN_PLACE, ARCANE_WOOD_HANGING_SIGN_HIT, ARCANE_WOOD_HANGING_SIGN_FALL);
    public static final ForgeSoundType INNOCENT_WOOD = new ForgeSoundType(1f, 1f, INNOCENT_WOOD_BREAK, INNOCENT_WOOD_STEP, INNOCENT_WOOD_PLACE, INNOCENT_WOOD_HIT, INNOCENT_WOOD_FALL);
    public static final ForgeSoundType INNOCENT_WOOD_HANGING_SIGN = new ForgeSoundType(1f, 1f, INNOCENT_WOOD_HANGING_SIGN_BREAK, INNOCENT_WOOD_HANGING_SIGN_STEP, INNOCENT_WOOD_HANGING_SIGN_PLACE, INNOCENT_WOOD_HANGING_SIGN_HIT, INNOCENT_WOOD_HANGING_SIGN_FALL);
    public static final ForgeSoundType CORK_BAMBOO = new ForgeSoundType(1f, 1f, CORK_BAMBOO_BREAK, CORK_BAMBOO_STEP, CORK_BAMBOO_PLACE, CORK_BAMBOO_HIT, CORK_BAMBOO_FALL);
    public static final ForgeSoundType CORK_BAMBOO_SAPLING = new ForgeSoundType(1f, 1f, CORK_BAMBOO_SAPLING_BREAK, CORK_BAMBOO_STEP, CORK_BAMBOO_SAPLING_PLACE, CORK_BAMBOO_SAPLING_HIT, CORK_BAMBOO_FALL);
    public static final ForgeSoundType CORK_BAMBOO_WOOD = new ForgeSoundType(1f, 1f, CORK_BAMBOO_WOOD_BREAK, CORK_BAMBOO_WOOD_STEP, CORK_BAMBOO_WOOD_PLACE, CORK_BAMBOO_WOOD_HIT, CORK_BAMBOO_WOOD_FALL);
    public static final ForgeSoundType CORK_BAMBOO_HANGING_SIGN = new ForgeSoundType(1f, 1f, CORK_BAMBOO_HANGING_SIGN_BREAK, CORK_BAMBOO_HANGING_SIGN_STEP, CORK_BAMBOO_HANGING_SIGN_PLACE, CORK_BAMBOO_HANGING_SIGN_HIT, CORK_BAMBOO_HANGING_SIGN_FALL);
    public static final ForgeSoundType WISESTONE = new ForgeSoundType(1f, 1f, WISESTONE_BREAK, WISESTONE_STEP, WISESTONE_PLACE, WISESTONE_HIT, WISESTONE_FALL);
    public static final ForgeSoundType POLISHED_WISESTONE = new ForgeSoundType(1f, 1f, POLISHED_WISESTONE_BREAK, POLISHED_WISESTONE_STEP, POLISHED_WISESTONE_PLACE, POLISHED_WISESTONE_HIT, POLISHED_WISESTONE_FALL);
    public static final ForgeSoundType WISESTONE_BRICKS = new ForgeSoundType(1f, 1f, WISESTONE_BRICKS_BREAK, WISESTONE_BRICKS_STEP, WISESTONE_BRICKS_PLACE, WISESTONE_BRICKS_HIT, WISESTONE_BRICKS_FALL);
    public static final ForgeSoundType WISESTONE_TILE = new ForgeSoundType(1f, 1f, WISESTONE_TILE_BREAK, WISESTONE_TILE_STEP, WISESTONE_TILE_PLACE, WISESTONE_TILE_HIT, WISESTONE_TILE_FALL);
    public static final ForgeSoundType CHISELED_WISESTONE = new ForgeSoundType(1f, 1f, CHISELED_WISESTONE_BREAK, CHISELED_WISESTONE_STEP, CHISELED_WISESTONE_PLACE, CHISELED_WISESTONE_HIT, WISESTONE_TILE_FALL);
    public static final ForgeSoundType MOR = new ForgeSoundType(1f, 1f, MOR_BREAK, MOR_STEP, MOR_PLACE, MOR_HIT, MOR_FALL);
    public static final ForgeSoundType ELDER_MOR = new ForgeSoundType(1f, 1f, ELDER_MOR_BREAK, ELDER_MOR_STEP, ELDER_MOR_PLACE, ELDER_MOR_HIT, ELDER_MOR_FALL);
    public static final ForgeSoundType MOR_BLOCK = new ForgeSoundType(1f, 1f, MOR_BLOCK_BREAK, MOR_BLOCK_STEP, MOR_BLOCK_PLACE, MOR_BLOCK_HIT, MOR_BLOCK_FALL);
    public static final ForgeSoundType ELDER_MOR_BLOCK = new ForgeSoundType(1f, 1f, ELDER_MOR_BLOCK_BREAK, ELDER_MOR_BLOCK_STEP, ELDER_MOR_BLOCK_PLACE, ELDER_MOR_BLOCK_HIT, ELDER_MOR_BLOCK_FALL);
    public static final ForgeSoundType CRYSTAL = new ForgeSoundType(1f, 1f, CRYSTAL_BREAK, CRYSTAL_STEP, CRYSTAL_PLACE, CRYSTAL_HIT, CRYSTAL_FALL);
