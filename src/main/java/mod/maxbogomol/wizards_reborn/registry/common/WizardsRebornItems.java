...
public class WizardsRebornItems {
    ...
    public static final RegistryObject<Item> VIOLENCE_BANNER_PATTERN = ITEMS.register("violence_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.VIOLENCE, WizardsRebornTags.VIOLENCE_BANNER_PATTERN, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> REPRODUCTION_BANNER_PATTERN = ITEMS.register("reproduction_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.REPRODUCTION, WizardsRebornTags.REPRODUCTION_BANNER_PATTERN, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> COOPERATION_BANNER_PATTERN = ITEMS.register("cooperation_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.COOPERATION, WizardsRebornTags.COOPERATION_BANNER_PATTERN, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> HUNGER_BANNER_PATTERN = ITEMS.register("hunger_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.HUNGER, WizardsRebornTags.HUNGER_BANNER_PATTERN, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> SURVIVAL_BANNER_PATTERN = ITEMS.register("survival_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.SURVIVAL, WizardsRebornTags.SURVIVAL_BANNER_PATTERN, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> ELEVATION_BANNER_PATTERN = ITEMS.register("elevation_banner_pattern", () -> new RainBannerPatternItem(RainBannerPatternItem.Types.ELEVATION, WizardsRebornTags.ELEVATION_BANNER_PATTERN, (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON)));
