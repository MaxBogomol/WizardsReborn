...
public class WizardsRebornBlocks {
    ...
    public static final RegistryObject<Block> CORK_BAMBOO_BUTTON = BLOCKS.register("cork_bamboo_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON).sound(WizardsRebornSounds.ARCANE_WOOD), WizardsRebornBlockSetTypes.CORK_BAMBOO, 30, true));
