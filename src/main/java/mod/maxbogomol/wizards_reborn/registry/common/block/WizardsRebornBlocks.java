...
import mod.maxbogomol.wizards_reborn.common.block.plant.centurial_hop.CenturialHopCropBlock;
import mod.maxbogomol.wizards_reborn.common.block.plant.centurial_hop.CenturialHopVinesBlock;
import mod.maxbogomol.wizards_reborn.common.block.plant.centurial_hop.CenturialHopVinesPlantBlock;
import mod.maxbogomol.wizards_reborn.common.block.plant.cork_bamboo.CorkBambooSaplingBlock;
import mod.maxbogomol.wizards_reborn.common.block.plant.cork_bamboo.CorkBambooStalkBlock;
...
import mod.maxbogomol.wizards_reborn.common.block.pitcher.PitcherTurnipBlock;
import mod.maxbogomol.wizards_reborn.common.block.pitcher.PottedPitcherTurnipBlock;
...
import mod.maxbogomol.wizards_reborn.common.block.plant.shiny_clover.ShinyCloverBlock;
import mod.maxbogomol.wizards_reborn.common.block.plant.shiny_clover.ShinyCloverCropBlock;
...
import mod.maxbogomol.wizards_reborn.common.block.plant.underground_grape.UndergroundGrapeVinesBlock;
import mod.maxbogomol.wizards_reborn.common.block.plant.underground_grape.UndergroundGrapeVinesPlantBlock;
...
public class WizardsRebornBlocks {
    ...
    public static final RegistryObject<Block> CENTURIAL_HOP_CROP = BLOCKS.register("centurial_hop_crop", () -> new CenturialHopCropBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).randomTicks().noCollission().instabreak().sound(SoundType.CAVE_VINES).pushReaction(PushReaction.DESTROY)));
    public static final RegistryObject<Block> CENTURIAL_HOP_VINES = BLOCKS.register("centurial_hop_vines", () -> new CenturialHopVinesBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).randomTicks().noCollission().instabreak().sound(SoundType.CAVE_VINES).pushReaction(PushReaction.DESTROY)));
    public static final RegistryObject<Block> CENTURIAL_HOP_VINES_PLANT = BLOCKS.register("centurial_hop_vines_plant", () -> new CenturialHopVinesPlantBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).randomTicks().noCollission().instabreak().sound(SoundType.CAVE_VINES).pushReaction(PushReaction.DESTROY)));
