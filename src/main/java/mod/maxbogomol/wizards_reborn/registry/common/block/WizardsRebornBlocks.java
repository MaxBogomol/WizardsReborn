...
public class WizardsRebornBlocks {
    ...
    public static final RegistryObject<Block> WHITE_CARGO_CARPET = BLOCKS.register("white_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL)));
    public static final RegistryObject<Block> LIGHT_GRAY_CARGO_CARPET = BLOCKS.register("light_gray_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_WOOL)));
    public static final RegistryObject<Block> GRAY_CARGO_CARPET = BLOCKS.register("gray_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.GRAY_WOOL)));
    public static final RegistryObject<Block> BLACK_CARGO_CARPET = BLOCKS.register("black_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.BLACK_WOOL)));
    public static final RegistryObject<Block> BROWN_CARGO_CARPET = BLOCKS.register("brown_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.BROWN_WOOL)));
    public static final RegistryObject<Block> RED_CARGO_CARPET = BLOCKS.register("red_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.RED_WOOL)));
    public static final RegistryObject<Block> ORANGE_CARGO_CARPET = BLOCKS.register("orange_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.ORANGE_WOOL)));
    public static final RegistryObject<Block> YELLOW_CARGO_CARPET = BLOCKS.register("yellow_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.YELLOW_WOOL)));
    public static final RegistryObject<Block> LIME_CARGO_CARPET = BLOCKS.register("lime_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.LIME_WOOL)));
    public static final RegistryObject<Block> GREEN_CARGO_CARPET = BLOCKS.register("green_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.GREEN_WOOL)));
    public static final RegistryObject<Block> CYAN_CARGO_CARPET = BLOCKS.register("cyan_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.CYAN_WOOL)));
    public static final RegistryObject<Block> LIGHT_BLUE_CARGO_CARPET = BLOCKS.register("light_blue_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_WOOL)));
    public static final RegistryObject<Block> BLUE_CARGO_CARPET = BLOCKS.register("blue_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.BLUE_WOOL)));
    public static final RegistryObject<Block> PURPLE_CARGO_CARPET = BLOCKS.register("purple_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.PURPLE_WOOL)));
    public static final RegistryObject<Block> MAGENTA_CARGO_CARPET = BLOCKS.register("magenta_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.MAGENTA_WOOL)));
    public static final RegistryObject<Block> PINK_CARGO_CARPET = BLOCKS.register("pink_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.PINK_WOOL)));
    public static final RegistryObject<Block> RAINBOW_CARGO_CARPET = BLOCKS.register("rainbow_cargo_carpet", () -> new CargoCarpetBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL)));
