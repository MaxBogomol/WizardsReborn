...
public class SpiritRepairPage extends RecipePage {
    public static final ResourceLocation BACKGROUND = new ResourceLocation(WizardsReborn.MOD_ID, "textures/gui/arcanemicon/integration/malum/spirit_repair_page.png");
    ...
    public SpiritRepairPage(ItemStack result, ItemStack input, ItemStack material) {
        super(BACKGROUND);
        this.result = result;
        this.input = input;
    ...
    public SpiritRepairPage setSpirits(ItemStack... items) {
        spirits = items;
        return this;
    }
    ...
    public void render(ArcanemiconScreen book, GuiGraphics gui, int x, int y, int mouseX, int mouseY) {
        drawItem(book, gui, material, x + 38, y + 56, mouseX, mouseY);
        drawItem(book, gui, input, x + 74, y + 56, mouseX, mouseY);
