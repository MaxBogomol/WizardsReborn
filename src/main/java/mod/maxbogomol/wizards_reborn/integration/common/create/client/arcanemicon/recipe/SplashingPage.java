...
public class SplashingPage extends RecipePage {
    public static final ResourceLocation BACKGROUND = new ResourceLocation(WizardsReborn.MOD_ID, "textures/gui/arcanemicon/integration/create/splashing_page.png");
    public ItemStack input;
    public ItemStack[] results;

    public SplashingPage(ItemStack input, ItemStack... results) {
        super(BACKGROUND);
        this.input = input;
