...
public class CrystalRitualRecipeCategory implements IRecipeCategory<CrystalRitualRecipe> {
    ...
    public CrystalRitualRecipeCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(WizardsRebornItems.RUNIC_PEDESTAL.get()));
    }
    ...
    public Component getTitle() {
        return Component.nullToEmpty(WizardsRebornBlocks.RUNIC_PEDESTAL.get().getName().getString());
    }
