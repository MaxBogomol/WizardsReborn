...
<recipetype:wizards_reborn:censer>.addRecipe("zs_test_14", <item:minecraft:diamond_block>, [<mobEffect:minecraft:strength>], [10], [0]);

//<recipetype:wizards_reborn:censer>.remove(<item:minecraft:diamond_block>);

<recipetype:wizards_reborn:alchemy_machine>.addRecipe("zs_test_15", <item:minecraft:diamond_block>, null, 100, 100, [<item:minecraft:dirt>], [<fluid:minecraft:water> * 50]);
...
<recipetype:wizards_reborn:alchemy_machine>.addRecipe("zs_test_16", <item:minecraft:diamond_block>, <fluid:minecraft:lava> * 345, 100, 100, [<item:minecraft:dirt>, <item:minecraft:dirt>], [<fluid:minecraft:water> * 50]);

<recipetype:wizards_reborn:arcane_iterator>.addRecipe("zs_test_17", <item:minecraft:diamond_block>, null, null, 10, 1, 1, false, [<item:minecraft:dirt>]);
<recipetype:wizards_reborn:arcane_iterator>.addRecipe("zs_test_18", <item:minecraft:diamond_sword>, <enchantment:minecraft:sharpness>, null, 100, 1, 1, false, [<item:minecraft:diamond_block>, <item:minecraft:diamond_block>, <item:minecraft:diamond_block>]);
